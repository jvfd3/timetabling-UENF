...
```bash
aws lambda create-function --function-name XXXDelete --runtime nodejs20.x --role arn:aws:iam::375423677214:role/LambdaRole --handler index.handler --zip-file fileb://B:/timetabling-UENF/Files/AWS/lambdas/XXXDelete/XXXDelete.zip --environment "Variables={DB_HOST='dbtimetabling.cgsgwtemx5r8.us-east-2.rds.amazonaws.com',DB_USER='tang',DB_PASSWORD='annabell',DB_NAME='timetabling'}"
```
