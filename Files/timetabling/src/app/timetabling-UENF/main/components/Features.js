  ...
  return (
    <Container id="features" sx={{ py: { xs: 8, sm: 16 } }}>
      <Box sx={{ width: { sm: "100%", md: "60%" } }}>
        ...
        >
          Neste sistema, você poderá criar, ler, editar e excluir turmas, salas,
          disciplinas, professores e alunos. Além disso, você poderá gerar as
          grades horárias e visualizar os conflitos de horários entre as turmas,
          facilitando o planejamento acadêmico.
        </Typography>
      </Box>
      {/*
      <Box
