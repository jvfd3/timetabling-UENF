const options = {
  constantValues: {
    ...
    blocks: [
      { id: 1,  código:  "E1", apelido: "Reitoria",       nome: "Reitoria, Sec. Acadêmica, administrativo e salas de aula"},
      { id: 5,  código:  "E2", apelido: "CCH",            nome: "Centro de Ciências do Homem"},
      { id: 11, código:  "P1", apelido: "CCTA",           nome: "Centro de Ciências e Tecnologias Agropecuárias"},
      { id: 9,  código:  "P2", apelido: "CBB",            nome: "Centro de Biociências e Biotecnologia"},
      { id: 6,  código:  "P3", apelido: "CCT",            nome: "Centro de Ciência e Tecnologia"},
      { id: 10, código:  "P4", apelido: "P4",             nome: "Laboratórios e salas de aula"},
      { id: 8,  código:  "P5", apelido: "P5",             nome: "Banco, Laboratório, administrativo e salas de aula"},
      { id: 17, código:  "P6", apelido: "P6",             nome: "1º prédio atrás das oficinas do CCT"},
      { id: 18, código:  "P7", apelido: "P7",             nome: "2º prédio atrás das oficinas do CCT"},
      { id: 19, código:  "P8", apelido: "P8",             nome: "3º prédio atrás das oficinas do CCT"},
      { id: 3,  código:  "P9", apelido: "Pró-Reitoria",   nome: "Pró-Reitorias, administrativo e salas de aula"},
      { id: 20, código: "P10", apelido: "P10",            nome: "5º prédio atrás do hospital veterinário"},
      { id: 21, código: "P11", apelido: "P11",            nome: "4º prédio atrás do hospital veterinário"},
      { id: 22, código: "P13", apelido: "P13",            nome: "3º prédio atrás do hospital veterinário"},
      { id: 23, código: "P15", apelido: "P15",            nome: "2º prédio atrás do hospital veterinário"},
      { id: 24, código: "P17", apelido: "P17",            nome: "1º prédio atrás do hospital veterinário"},
      { id: 2,  código:  null, apelido: "Prefeitura",     nome: "Prefeitura do Campus"},
      { id: 4,  código:  null, apelido: "RU",             nome: "Restaurante Universitário"},
      { id: 7,  código:  null, apelido: "Ofic. CCT",      nome: "Oficinas do CCT"},
      { id: 12, código:  null, apelido: "Apitão",         nome: "Centro de Convenções"},
      { id: 13, código:  null, apelido: "Esp. Ciênc.",    nome: "Espaço da Ciência"},
      { id: 14, código:  null, apelido: "Hosp. Vet.",     nome: "Hospital Veterinário"},
      { id: 15, código:  null, apelido: "Lanchonete",     nome: "Lanchonete e loja de Conveniências"},
      { id: 16, código:  null, apelido: "Casa Ecológica", nome: "Casa Ecológica"},
    ],
  },
  emptyObjects: {
    turma: {
