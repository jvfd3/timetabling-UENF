const options = {
  constantValues: {
    ...
    blocks: [
      { id:  1, code:  "E1", alias:        "Reitoria", name: "Reitoria, Sec. Acadêmica, administrativo e salas de aula" },
      { id:  5, code:  "E2", alias:             "CCH", name: "Centro de Ciências do Homem"                              },
      { id: 11, code:  "P1", alias:            "CCTA", name: "Centro de Ciências e Tecnologias Agropecuárias"           },
      { id:  9, code:  "P2", alias:             "CBB", name: "Centro de Biociências e Biotecnologia"                    },
      { id:  6, code:  "P3", alias:             "CCT", name: "Centro de Ciência e Tecnologia"                           },
      { id: 10, code:  "P4", alias:              "P4", name: "Laboratórios e salas de aula"                             },
      { id:  8, code:  "P5", alias:              "P5", name: "Banco, Laboratório, administrativo e salas de aula"       },
      { id: 17, code:  "P6", alias:              "P6", name: "1º prédio atrás das oficinas do CCT"                      },
      { id: 18, code:  "P7", alias:              "P7", name: "2º prédio atrás das oficinas do CCT"                      },
      { id: 19, code:  "P8", alias:              "P8", name: "3º prédio atrás das oficinas do CCT"                      },
      { id:  3, code:  "P9", alias:    "Pró-Reitoria", name: "Pró-Reitorias, administrativo e salas de aula"            },
      { id: 20, code: "P10", alias:             "P10", name: "5º prédio atrás do hospital veterinário"                  },
      // { id: 21, code: "P11", alias:             "P11", name: "4º prédio atrás do hospital veterinário"                  },
      // { id: 22, code: "P13", alias:             "P13", name: "3º prédio atrás do hospital veterinário"                  },
      // { id: 23, code: "P15", alias:             "P15", name: "2º prédio atrás do hospital veterinário"                  },
      // { id: 24, code: "P17", alias:             "P17", name: "1º prédio atrás do hospital veterinário"                  },
      // { id:  2, code:  null, alias:      "Prefeitura", name: "Prefeitura do Campus"                                     },
      // { id:  4, code:  null, alias:              "RU", name: "Restaurante Universitário"                                },
      // { id:  7, code:  null, alias:       "Ofic. CCT", name: "Oficinas do CCT"                                          },
      // { id: 12, code:  null, alias:          "Apitão", name: "Centro de Convenções"                                     },
      // { id: 13, code:  null, alias:     "Esp. Ciênc.", name: "Espaço da Ciência"                                        },
      // { id: 14, code:  null, alias:      "Hosp. Vet.", name: "Hospital Veterinário"                                     },
      // { id: 15, code:  null, alias:      "Lanchonete", name: "Lanchonete e loja de Conveniências"                       },
      // { id: 16, code:  null, alias:  "Casa Ecológica", name: "Casa Ecológica"                                           },
    ],
  },
  emptyObjects: {
    turma: {
