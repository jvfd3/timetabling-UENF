const options = {
  constantValues: {
    ...
    blocks: [
      ...
      { id:  3, code:  "P1", alias:            "CCTA", name: "Centro de Ciências e Tecnologias Agropecuárias"           },
      { id:  4, code:  "P2", alias:             "CBB", name: "Centro de Biociências e Biotecnologia"                    },
      { id:  5, code:  "P3", alias:             "CCT", name: "Centro de Ciência e Tecnologia"                           },
      { id:  6, code:  "P4", alias:              "P4", name: "Laboratórios e salas de aula"                             },
      { id:  7, code:  "P5", alias:              "P5", name: "Banco, Laboratório, administrativo e salas de aula"       },
      { id:  8, code:  "P6", alias:              "P6", name: "1º prédio atrás das oficinas do CCT"                      },
      { id:  9, code:  "P7", alias:              "P7", name: "2º prédio atrás das oficinas do CCT"                      },
      { id: 10, code:  "P8", alias:              "P8", name: "3º prédio atrás das oficinas do CCT"                      },
      { id: 11, code:  "P9", alias:    "Pró-Reitoria", name: "Pró-Reitorias, administrativo e salas de aula"            },
      { id: 12, code: "P10", alias:             "P10", name: "5º prédio atrás do hospital veterinário"                  },
    ],
  },
  emptyObjects: {
    turma: {
  ...
  yetUnusedValues: {
    ...
    otherBlocks: [
      { id: 13, code: "P11", alias:             "P11", name: "4º prédio atrás do hospital veterinário"                  },
      { id: 14, code: "P13", alias:             "P13", name: "3º prédio atrás do hospital veterinário"                  },
      { id: 15, code: "P15", alias:             "P15", name: "2º prédio atrás do hospital veterinário"                  },
      { id: 16, code: "P17", alias:             "P17", name: "1º prédio atrás do hospital veterinário"                  },
      ...
      { id: 23, code:  null, alias:      "Lanchonete", name: "Lanchonete e loja de Conveniências"                       },
